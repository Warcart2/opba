...
public abstract class StrawHatItem extends ArmorItem {
	public StrawHatItem(EquipmentSlot slot, Item.Properties properties) {
		super(new ArmorMaterial() {
			...
			public Ingredient getRepairIngredient() {
				return Ingredient.of(new ItemStack(Items.WHEAT));
			}
	...
	public static class Helmet extends StrawHatItem {
		public Helmet() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "opba:textures/entities/straw_hat.png";
		}
	}
}
