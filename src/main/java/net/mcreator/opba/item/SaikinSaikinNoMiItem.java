...
import net.mcreator.opba.procedures.SaikinSaikinNoMiPlayerFinishesUsingItemProcedure;
import net.mcreator.opba.init.OpbaModTabs;

public class SaikinSaikinNoMiItem extends Item {
	public SaikinSaikinNoMiItem() {
	...
	public ItemStack finishUsingItem(ItemStack itemstack, Level world, LivingEntity entity) {
		...
		SaikinSaikinNoMiPlayerFinishesUsingItemProcedure.execute(entity);
		return retval;
	}
}
