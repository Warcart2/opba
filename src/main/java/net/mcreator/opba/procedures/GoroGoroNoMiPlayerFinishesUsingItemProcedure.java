...
public class GoroGoroNoMiPlayerFinishesUsingItemProcedure {
	public static void execute(LevelAccessor world, Entity entity) {
		...
		if (((entity.getCapability(OpbaModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new OpbaModVariables.PlayerVariables())).DevilFruit).equals("None") || new Object() {
			...
			OpbaModVariables.MapVariables.get(world).GoroGoroUser = (entity.getDisplayName().getString()).toLowerCase();
