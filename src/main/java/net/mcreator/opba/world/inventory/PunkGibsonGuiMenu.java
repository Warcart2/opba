...
public class PunkGibsonGuiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public PunkGibsonGuiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(OpbaModMenus.PUNK_GIBSON_GUI, id);
