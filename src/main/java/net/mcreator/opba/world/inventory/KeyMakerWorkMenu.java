...
public class KeyMakerWorkMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public KeyMakerWorkMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(OpbaModMenus.KEY_MAKER_WORK, id);
